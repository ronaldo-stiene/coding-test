...
<div class="row justify-content-between m-0 my-2 gg-btn-outline-light rounded">
    <a class="col-2 row justify-content-center border-right bg-white rounded m-0 p-1 mr-3" href="{{ route('produto', ['id' => $produto->id]) }}">
            <img src="/storage/img/{{$produto->imagem}}" alt="Imagem da {{$produto->nome}}" class="gg-posicao-imagem-estoque w-100">
    </a>
    <div class="col p-0 gg-produto-detalhes-h">
        ...
        <div class="text-secondary text-decoration-none">
            ...
            <p class="mb-0 d-none d-lg-block">CEP: {{ preg_replace(
                    '/(\d{5})(\d{3})/', '${1}-${2}', 
            ...
            <p class="mb-0 d-none d-md-block">{{ ucfirst($produto->fornecedor->getEndereco()->rua) . ", " . 
